...
public class SLNPatcher extends CopyTask{
    ...
    public SLNPatcher(String gameversion, String slnversion, boolean force,String ab) {
        super(new File("RADS/projects/"+ab+"/releases/"+gameversion+"/deploy/"), 
              new File("RADS/solutions/"+ab+"/releases/"+slnversion+"/deploy/"), true);
